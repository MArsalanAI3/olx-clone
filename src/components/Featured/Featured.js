...
function Featured({ deviceType }) {
    return (
        //  <div className='container-fluid featuredParent mr-5 ml-5'>
            //  <div className='row'>
    <>
                <h3 className='text-dark ml-5 '>Based on your last search</h3>
                <Carousel
                className='container-fluid featuredParent mr-5 ml-5'
                    swipeable={true}
                    draggable={true}
                    showDots={true}
